            ...
            <div class="col-md-12 heading" style="padding: 0px; position: relative; height: 100%; background:#336699; ">
                ...
                <div class="holdWriteUp">
                    ...
                    <p class="text-center carryBottom text_white">
                        Internacional Trust Bank makes digital payments and transfers easy with various credit, debit and ATM card options to suit your needs. You'll appreciate the anytime access and other convenient features of these cards.
                    </p>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="feature-box-4-grid1 "  style="background: transparent;">
                                    <div class="feature-box text-center">
                                        ...
                                        <p class="subtext">Your Internacional Trust Bank personal checking account includes one of our feature-rich Debit MasterCard® options. </p>
